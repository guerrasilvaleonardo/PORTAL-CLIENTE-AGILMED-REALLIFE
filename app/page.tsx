...
return ( <main style={styles.page}> <div style={styles.container}> <div style={styles.welcome}> <h1 style={styles.welcomeTitle}>
Olá, {perfil?.nome || 'Cliente'}! </h1>

```
      <p style={styles.welcomeText}>
        Bem-vindo ao Portal do Cliente {tema.nome}.
      </p>
    </div>
    ...
    >
      <div style={styles.card}>
        <p style={styles.cardLabel}>Chamados recentes</p>
        <p style={styles.cardValue}>{totalChamados}</p>
      </div>

      <div style={styles.card}>
        <p style={styles.cardLabel}>Em andamento</p>
        <p style={styles.cardValue}>{abertos}</p>
      </div>

      <div style={styles.card}>
        <p style={styles.cardLabel}>Resolvidos</p>
        <p style={styles.cardValue}>{resolvidos}</p>
      </div>

      <div style={styles.card}>
        <p style={styles.cardLabel}>Urgentes</p>
        <p style={styles.cardValue}>{urgentes}</p>
      </div>
    </div>
    ...
    <div style={styles.actionsGrid}>
      ...
      >
        <div>
          <h2 style={styles.actionTitle}>Novo chamado</h2>
      ...
      >
        <div>
          <h2 style={styles.actionTitle}>Meus chamados</h2>

          <p style={styles.actionText}>
            Consulte seus chamados, mensagens e andamento.
          </p>
        </div>

        <strong>Ver chamados →</strong>
      </Link>
    </div>
    ...
    perfil?.perfil === 'admin' ? (
      <div style={{ marginBottom: '28px' }}>
        ...
        >
          ...
          >
            Acesse a área de gestão e atendimento dos
            chamados.
          </span>
        </Link>
      </div>
    ...
    <section style={styles.section}>
      ...
      {chamados.length === 0 ? (
        <div style={styles.empty}>
          ...
          >
            Clique em “Novo chamado” para solicitar
            atendimento.
          </p>
        </div>
      ) : (
