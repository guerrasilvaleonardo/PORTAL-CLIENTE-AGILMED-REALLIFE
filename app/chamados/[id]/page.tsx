...
> <div style={styles.container}> <div style={styles.loading}>
<div
style={{
...
/>
Carregando chamado... </div> </div> </main>
)
}

if (!chamado) {
return ( <main style={styles.page}> <div style={styles.container}> <div style={styles.errorCard}> <h1 style={styles.errorTitle}>
Chamado não encontrado </h1>
...
> <div style={styles.container}> <div style={styles.topBar}> <div> <Link
           href="/chamados"
           style={styles.backLink}
         >
← Voltar para chamados </Link>
...
return ( <div> <div style={styles.label}>{label}</div> <div style={styles.infoValue}>{value}</div> </div>
)
}
...
return ( <div style={styles.timelineItem}> <div style={styles.timelineRail}>
<div
style={{
...styles.timelineDot,
...(active
